...
def spawn_co_rpc(ch, method, properties, body):
    ...
    spawn_model_client(rover_name,
                                       open("/home/levakuz/UAV_Swarm_gazebo/Autopilot/Tools/sitl_gazebo/models/ral_x6/ral_x6.sdf", 'r').read(),
...
print("here")
spawn_model_client(rover_name,
                                   open("/home/levakuz/UAV_Swarm_gazebo/Autopilot/Tools/sitl_gazebo/models/iris_dual_gps/iris_dual_gps.sdf", 'r').read(),
